...
var Style_Style = /*#__PURE__*/function () {
  ...
  Style_createClass(Style, [{
    ...
    value: function fromNode($node) {
      ...
      var fontSizeUnit = this.options.forceFontSizeUnit ? this.options.forceFontSizeUnit : fontSize.match(/[a-z%]+$/);
      styleInfo['font-size'] = parseInt(fontSize, 10);
      styleInfo['font-size-unit'] = fontSizeUnit;
      return styleInfo;
    }
    /**
...
var Editor_Editor = /*#__PURE__*/function () {
  function Editor(context) {
    ...
    this.lastRange = null;
    this.snapshot = null;
    this.style = new Style_Style(this.options);
