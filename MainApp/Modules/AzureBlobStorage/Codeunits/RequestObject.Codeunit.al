...
codeunit 5282627 "ACA Request Object"
{
    trigger OnRun()
    begin
    ...
    var
        ...
        ApiVersion: Enum "ACA API Version";
        AzureConnectionType: Enum "ACA Azure Connection Type";
        Secret: Text;
    ...
    begin
        InitializeRequest(NewStorageAccountName, '', Enum::"ACA Azure Connection Type"::"Blob Container");
    end;

    procedure InitializeRequest(NewStorageAccountName: Text; NewAzureConnectionType: Enum "ACA Azure Connection Type")
    begin
        InitializeRequest(NewStorageAccountName, '', NewAzureConnectionType);
    end;

    procedure InitializeRequest(NewStorageAccountName: Text; NewContainerName: Text)
    begin
        InitializeRequest(NewStorageAccountName, NewContainerName, '', Enum::"ACA Azure Connection Type"::"Blob Container");
    end;

    procedure InitializeRequest(NewStorageAccountName: Text; NewContainerName: Text; NewAzureConnectionType: Enum "ACA Azure Connection Type")
    begin
        InitializeRequest(NewStorageAccountName, NewContainerName, '', NewAzureConnectionType);
    end;

    procedure InitializeRequest(NewStorageAccountName: Text; NewContainerName: Text; NewBlobName: Text)
    begin
        InitializeRequest(NewStorageAccountName, NewContainerName, NewBlobName, ApiVersion::"2017-04-17", Enum::"ACA Azure Connection Type"::"Blob Container");
    end;

    procedure InitializeRequest(NewStorageAccountName: Text; NewContainerName: Text; NewBlobName: Text; NewAzureConnectionType: Enum "ACA Azure Connection Type")
    begin
        InitializeRequest(NewStorageAccountName, NewContainerName, NewBlobName, ApiVersion::"2017-04-17", NewAzureConnectionType);
    end;

    procedure InitializeRequest(NewStorageAccountName: Text; NewContainerName: Text; NewBlobName: Text; NewApiVersion: Enum "ACA API Version"; NewAzureConnectionType: Enum "ACA Azure Connection Type")
    begin
        StorageAccountName := NewStorageAccountName;
        ContainerName := NewContainerName;
        BlobName := NewBlobName;
        ApiVersion := NewApiVersion;
        AzureConnectionType := NewAzureConnectionType;
    end;
    // #endregion Initialize Requests

    procedure InitializeAuthorization(NewAuthType: Enum "ACA Authorization Type"; NewSecret: Text)
    begin
    ...
    procedure SetOperation(NewOperation: Enum "ACA Blob Storage Operation")
    begin
    ...
    procedure GetOperation(): Enum "ACA Blob Storage Operation"
    begin
        exit(Operation);
    end;

    procedure SetAuthorizationType(NewAuthType: Enum "ACA Authorization Type")
    begin
        AuthType := NewAuthType;
    end;

    procedure GetAuthorizationType(): Enum "ACA Authorization Type"
    begin
        exit(AuthType);
    end;
    ...
    procedure SetApiVersion(NewApiVersion: Enum "ACA API Version")
    begin
        ApiVersion := NewApiVersion;
    end;

    procedure GetApiVersion(): Enum "ACA API Version"
    begin
        exit(ApiVersion);
    end;

    procedure SetConnectionType(NewAzureConnectionType: Enum "ACA Azure Connection Type")
    begin
        AzureConnectionType := NewAzureConnectionType;
    end;

    procedure GetConnectionType(): Enum "ACA Azure Connection Type"
    begin
        exit(AzureConnectionType);
    end;
    ...
    var
        URIHelepr: Codeunit "ACA URI Helper";
    begin
        URIHelepr.SetOptionalUriParameter(OptionalUriParameters);
        exit(URIHelepr.ConstructUri(StorageAccountName, ContainerName, BlobName, Operation, AuthType, Secret, AzureConnectionType));
    end;
    ...
    var
        ReqAuthAccessKey: Codeunit "ACA Req. Auth. Access Key";
    begin
    ...
    #region Azure File Share API
    procedure SetIncludeTimeStamps()
    begin
        //API must be 2020-04-08 or newer
        AddOptionalHeader('x-ms-file-extended-info', 'true');
        AddOptionalUriParameter('include', 'Timestamps');
    end;
    #endregion Azure File Share API
}
