...
codeunit 5282622 "ACA Blob Storage API"
{
    ...
    procedure CreateContainer(var RequestObject: Codeunit "ACA Request Object")
    var
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>
    procedure ListContainers(var RequestObject: Codeunit "ACA Request Object")
    begin
    ...
    procedure ListContainers(var RequestObject: Codeunit "ACA Request Object"; ShowOutput: Boolean)
    var
    ...
    /// <param name="ShowOutput">Determines if the result should be shown as a Page to the user.</param>
    procedure ListContainers(var RequestObject: Codeunit "ACA Request Object"; var Container: Record "ACA Container"; ShowOutput: Boolean)
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>
    procedure DeleteContainer(var RequestObject: Codeunit "ACA Request Object")
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
    begin
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    procedure ListBlobs(var RequestObject: Codeunit "ACA Request Object")
    begin
    ...
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    /// <param name="ShowOutput">Determines if the result should be shown as a Page to the user.</param>
    procedure ListBlobs(var RequestObject: Codeunit "ACA Request Object"; ShowOutput: Boolean)
    var
    ...
    /// <param name="ShowOutput">Determines if the result should be shown as a Page to the user.</param>
    procedure ListBlobs(var RequestObject: Codeunit "ACA Request Object"; var ContainerContent: Record "ACA Container Content"; ShowOutput: Boolean)
    var
        HelperLibrary: Codeunit "ACA Helper Library";
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    procedure UploadBlobIntoContainerUI(var RequestObject: Codeunit "ACA Request Object")
    var
        Filename: Text;
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>
    procedure DownloadBlobAsFileWithSelect(var RequestObject: Codeunit "ACA Request Object")
    var
        ContainerContent: Record "ACA Container Content";
        HelperLibrary: Codeunit "ACA Helper Library";
        BlobName: Text;
    ...
    procedure DeleteBlobFromContainerUI(var RequestObject: Codeunit "ACA Request Object")
    var
        ContainerContent: Record "ACA Container Content";
        HelperLibrary: Codeunit "ACA Helper Library";
        BlobName: Text;
    ...
    procedure DeleteBlobFromContainer(var RequestObject: Codeunit "ACA Request Object")
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
    begin
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    procedure ContainerLeaseAcquire(var RequestObject: Codeunit "ACA Request Object")
    var
    ...
    procedure ContainerLeaseAcquire(var RequestObject: Codeunit "ACA Request Object"; DurationSeconds: Integer)
    var
        ProposedLeaseId: Guid;
    begin
    ...
    procedure ContainerLeaseAcquire(var RequestObject: Codeunit "ACA Request Object"; ProposedLeaseId: Guid)
    begin
    ...
    /// <param name="DurationSeconds">Specifies the duration of the lease, in seconds, or negative one (-1) for a lease that never expires</param>
    /// <param name="ProposedLeaseId">Proposed lease ID, in a GUID string format</param>
    procedure ContainerLeaseAcquire(var RequestObject: Codeunit "ACA Request Object"; DurationSeconds: Integer; ProposedLeaseId: Guid)
    var
        Operation: Enum "ACA Blob Storage Operation";
    begin
    ...
    procedure ContainerLeaseRelease(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid)
    var
        Operation: Enum "ACA Blob Storage Operation";
    begin
        RequestObject.SetOperation(Operation::LeaseContainer);
    ...
    procedure ContainerLeaseRenew(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid)
    var
        Operation: Enum "ACA Blob Storage Operation";
    begin
        RequestObject.SetOperation(Operation::LeaseContainer);
    ...
    procedure ContainerLeaseBreak(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid)
    var
        Operation: Enum "ACA Blob Storage Operation";
    begin
        RequestObject.SetOperation(Operation::LeaseContainer);
    ...
    procedure ContainerLeaseChange(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid; ProposedLeaseId: Guid)
    var
        Operation: Enum "ACA Blob Storage Operation";
    begin
        RequestObject.SetOperation(Operation::LeaseContainer);
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    procedure BlobLeaseAcquire(var RequestObject: Codeunit "ACA Request Object")
    var
        ProposedLeaseId: Guid;
    begin
    ...
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>
    /// <param name="DurationSeconds">Specifies the duration of the lease, in seconds, or negative one (-1) for a lease that never expires</param>
    procedure BlobLeaseAcquire(var RequestObject: Codeunit "ACA Request Object"; DurationSeconds: Integer)
    var
        ProposedLeaseId: Guid;
    begin
    ...
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    /// <param name="ProposedLeaseId">Proposed lease ID, in a GUID string format</param>
    procedure BlobLeaseAcquire(var RequestObject: Codeunit "ACA Request Object"; ProposedLeaseId: Guid)
    begin
    ...
    /// <param name="DurationSeconds">Specifies the duration of the lease, in seconds, or negative one (-1) for a lease that never expires</param>
    /// <param name="ProposedLeaseId">Proposed lease ID, in a GUID string format</param>
    procedure BlobLeaseAcquire(var RequestObject: Codeunit "ACA Request Object"; DurationSeconds: Integer; ProposedLeaseId: Guid)
    var
        Operation: Enum "ACA Blob Storage Operation";
    begin
    ...
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>
    /// <param name="LeaseId">The Guid for the lease that should be freed</param>
    procedure BlobLeaseRelease(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid)
    var
        Operation: Enum "ACA Blob Storage Operation";
    begin
        RequestObject.SetOperation(Operation::LeaseBlob);
    ...
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>
    /// <param name="LeaseId">The Guid for the lease that should be renewed</param>
    procedure BlobLeaseRenew(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid)
    var
        Operation: Enum "ACA Blob Storage Operation";
    begin
        RequestObject.SetOperation(Operation::LeaseBlob);
    ...
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>
    /// <param name="LeaseId">The Guid for the lease that should be broken</param>
    procedure BlobLeaseBreak(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid)
    var
        Operation: Enum "ACA Blob Storage Operation";
    begin
        RequestObject.SetOperation(Operation::LeaseBlob);
    ...
    /// <param name="LeaseId">The Guid for the lease that should be changed</param>
    /// <param name="ProposedLeaseId">The Guid that should be used in future</param>    
    procedure BlobLeaseChange(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid; ProposedLeaseId: Guid)
    var
        Operation: Enum "ACA Blob Storage Operation";
    begin
        RequestObject.SetOperation(Operation::LeaseBlob);
    ...
    local procedure LeaseAcquire(var RequestObject: Codeunit "ACA Request Object"; DurationSeconds: Integer; ProposedLeaseId: Guid; OperationNotSuccessfulErr: Text)
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
    begin
    ...
    local procedure LeaseRelease(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid; OperationNotSuccessfulErr: Text)
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
    begin
    ...
    local procedure LeaseRenew(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid; OperationNotSuccessfulErr: Text)
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
    begin
    ...
    local procedure LeaseBreak(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid; OperationNotSuccessfulErr: Text)
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
    begin
    ...
    local procedure LeaseChange(var RequestObject: Codeunit "ACA Request Object"; LeaseId: Guid; ProposedLeaseId: Guid; OperationNotSuccessfulErr: Text)
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
    begin
    ...
    procedure CopyBlob(var RequestObject: Codeunit "ACA Request Object"; SourceName: Text)
    var
        LeaseId: Guid;
    begin
    ...
    procedure CopyBlob(var RequestObject: Codeunit "ACA Request Object"; SourceName: Text; LeaseId: Guid)
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
    begin
    ...
    procedure AbortCopyBlob(var RequestObject: Codeunit "ACA Request Object"; CopyId: Guid)
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
    ...
    procedure GetBlobServiceProperties(var RequestObject: Codeunit "ACA Request Object"): XmlDocument
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        FormatHelper: Codeunit "ACA Format Helper";
        Operation: Enum "ACA Blob Storage Operation";
    ...
    procedure SetBlobServiceProperties(var RequestObject: Codeunit "ACA Request Object"; Document: XmlDocument)
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
        Content: HttpContent;
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    procedure GetBlobProperties(var RequestObject: Codeunit "ACA Request Object")
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
        ResponseText: Text;
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    procedure SetBlobProperties(var RequestObject: Codeunit "ACA Request Object")
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
        Content: HttpContent;
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    procedure GetContainerMetadata(var RequestObject: Codeunit "ACA Request Object")
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
        ResponseText: Text;
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    procedure SetContainerMetadata(var RequestObject: Codeunit "ACA Request Object")
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
    begin
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    procedure GetBlobMetadata(var RequestObject: Codeunit "ACA Request Object")
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
        ResponseText: Text;
    ...
    /// </summary>
    /// <param name="RequestObject">A Request Object containing the necessary parameters for the request.</param>    
    procedure SetBlobMetadata(var RequestObject: Codeunit "ACA Request Object")
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
    begin
    ...
    procedure GetContainerACL(var RequestObject: Codeunit "ACA Request Object"): XmlDocument
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        FormatHelper: Codeunit "ACA Format Helper";
        Operation: Enum "ACA Blob Storage Operation";
    ...
    procedure SetContainerACL(var RequestObject: Codeunit "ACA Request Object"; Document: XmlDocument)
    var
        WebRequestHelper: Codeunit "ACA Web Request Helper";
        Operation: Enum "ACA Blob Storage Operation";
        Content: HttpContent;
