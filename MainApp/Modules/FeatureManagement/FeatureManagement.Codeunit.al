codeunit 5282617 "ACA Feature Management"
{
    ...
    var
        ...
        ExperienceTier: Text;
        ExperienceTierMissingNotificationMsg: Label 'No experience tier selected for the current company. The feature management will not work properly without an experience tier.';
